...
We need 3D Optical Flow based tracking for real-time performance wrt moving cameras. A better model of the Light Curtain would have to be learnt as well with regards to how albedo/normals on surfaces are handled
